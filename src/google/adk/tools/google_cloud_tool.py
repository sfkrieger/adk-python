...
from .google_cloud_credentials import GoogleCloudCredentialsManager
from .tool_context import ToolContext


@experimental
class GoogleCloudTool(FunctionTool):
  ...
  def __init__(
      ...
      func: Callable[..., Any],
      *,
      credentials_config: Optional[GoogleCloudCredentialsConfig] = None,
    ...
    self._credentials_manager = (
        GoogleCloudCredentialsManager(credentials_config)
