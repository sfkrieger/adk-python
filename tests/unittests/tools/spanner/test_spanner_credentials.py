...
class TestSpannerCredentials:
  ...
  def test_valid_credentials_object_auth_credentials(self):
    ...
    config = SpannerCredentialsConfig(credentials=auth_creds)
    ...
    assert config.scopes == ["https://www.googleapis.com/auth/spanner.data"]
  ...
  def test_missing_client_secret_raises_error(self):
    ...
    with pytest.raises(
      ...
      SpannerCredentialsConfig(client_id="test_client_id")
  ...
  def test_missing_client_id_raises_error(self):
    ...
    with pytest.raises(
      ...
      SpannerCredentialsConfig(client_secret="test_client_secret")
