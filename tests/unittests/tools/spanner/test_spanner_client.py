...
def test_spanner_client_user_agent():
  ...
  with mock.patch("google.cloud.spanner.Client") as mock_client_class:
    ...
    # Verify that the Spanner Client was instantiated with the correct
    # arguments.
    # The 'mock_client_class' is a mock of the class itself.
    # Its 'call_args' property holds the arguments from its instantiation.
    mock_client_class.assert_called_once()
    call_kwargs = mock_client_class.call_args[1]

    # Extract the client_info argument and check its user_agent.
